...
_G.packer_plugins = {
  ...
  kommentary = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/kommentary",
  ...
  neogit = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/vim-vsnip",
    url = "https://github.com/hrsh7th/vim-vsnip"
  },
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
